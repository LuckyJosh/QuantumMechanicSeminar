\begin{frame}{Integrierte Information}
		\begin{columns}
			\alt<1,2,3>{\begin{column}{0.55\textwidth}
				\begin{itemize}
			...
			\begin{column}{0.5\textwidth}
				...
				\alt<3>{\includegraphics[scale=0.13]{graphics/integrated_information_graph.jpg}\cite{Tegmark_15_long}}{}
			\end{column}}{}
			
		\alt<4>{\begin{column}{0.55\textwidth}
				\begin{itemize}
