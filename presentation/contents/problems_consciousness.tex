\begin{frame}{Bewusstsein}
	\begin{itemize}
		...
		\begin{itemize}
			\item{\Quote{ An other argument is that physics has been managed just fine for hundreds of years avoiding this subject and should therefore keep doing so.} - Max Tegmark\,\cite{Tegmark_15_long}}
